...
INSERT INTO users (id, email, password, created_at, updated_at, email_verified, is_active) 
VALUES ('967d5bb5-3a7a-4d5e-8a6c-febc8c5b3f13', 't@t.io', '$2a$10$M31dwIPy1MXx9w3Kn9ac3.5B8uW53xrwhnUrRO5.M7ZnKmrenq3zu', '2019-10-01 15:36:38'::timestamp, '2019-10-01 15:36:38'::timestamp, true, true);
INSERT INTO users (id, email, password, created_at, updated_at, email_verified, is_active) 
VALUES ('f1bfae38-e925-4556-8b05-a1d29f6e85fc', 'admin@t.io', '$2a$10$M31dwIPy1MXx9w3Kn9ac3.5B8uW53xrwhnUrRO5.M7ZnKmrenq3zu', '2019-10-01 15:36:38'::timestamp, '2019-10-01 15:36:38'::timestamp, true, true);
